// Copy this entire script and paste it into your MongoDB shell
// It will fix all 3 broken group requests automatically
...
if (repairedCount === brokenRequestIds.length) {
  ...
  console.log('4. Group names, leads, and members should display correctly');
} else {
