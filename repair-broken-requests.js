// Data repair script for broken AdminAssignmentRequest records
const fs = require('fs');
const path = require('path');

console.log('🔧 REPAIRING BROKEN ADMIN ASSIGNMENT REQUESTS');
console.log('=============================================\n');

// This script will:
// 1. Find all group requests missing groupId
// 2. Match them to their projects
// 3. Create missing Group documents
// 4. Update the requests with proper groupId
...
fs.writeFileSync(path.join(__dirname, 'execute-repair.js'), repairScript);

console.log('✅ Repair script created: execute-repair.js');
console.log('\n📝 INSTRUCTIONS:');
console.log('1. Run: node execute-repair.js');
console.log('2. This will find and fix all broken group requests');
console.log('3. Check the console output for repair details');
console.log('\n🔧 WHAT THE SCRIPT DOES:');
console.log('- Finds group requests missing groupId');
...
console.log('- Reports all repair actions');
