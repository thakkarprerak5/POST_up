...
import { SimpleProfilePhoto } from "./simple-profile-photo";
          ...
          <div className={`${innerPadding} pt-1`}>
            <div className="flex items-center gap-2">
              ...
              {project.author.name === 'ganpat' ? (
                ...
                >
                  {/* Check if ganpat has actual photo (not placeholder) */}
                  {(project.author.image && project.author.image !== '/placeholder-user.jpg') ? (
                    ...
                    /* Show "G" fallback when no actual photo */
