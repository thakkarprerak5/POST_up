// Debug script to inspect AdminAssignmentRequest records and trace the issue
const fs = require('fs');
const path = require('path');

console.log('🔍 DEBUGGING GROUP REQUESTS');
console.log('============================\n');
...
fs.writeFileSync(path.join(__dirname, 'execute-debug.js'), debugScript);

console.log('✅ Debug script created: execute-debug.js');
console.log('\n📝 INSTRUCTIONS:');
console.log('1. Run: node execute-debug.js');
console.log('2. This will analyze all group requests and identify issues');
console.log('3. Check the output for specific problems');
console.log('\n🔍 WHAT THE SCRIPT DOES:');
console.log('- Lists all AdminAssignmentRequest documents');
console.log('- Analyzes group requests specifically');
console.log('- Checks projectId, groupId, and groupSnapshot');
console.log('- Verifies associated Project and Group documents');
console.log('- Identifies exactly what\'s missing or broken');
