...
"[project]/Downloads/POST_up-main/models/Project.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Project = /*TURBOPACK member replacement*/ __turbopack_context__.g.Project || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('Project', ProjectSchema);
if ("TURBOPACK compile-time truthy", 1) {
    /*TURBOPACK member replacement*/ __turbopack_context__.g.Project = Project;
}
const createProject = async (data)=>{
    const project = new Project(data);
    return project.save();
};
const listProjects = async (query = {}, options = {})=>{
    const { limit = 20, sort = {
        createdAt: -1
    } } = options;
...
"[project]/Downloads/POST_up-main/app/api/projects/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/POST_up-main/models/Project.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/POST_up-main/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/POST_up-main/node_modules/next-auth/index.js [app-route] (ecmascript)");
...
async function GET(request) {
    ...
    const projects = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listProjects"])(query, {
        limit,
        sort: {
            createdAt: -1
        }
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(projects);
}
async function POST(request) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
    if (!session?.user?.id) {
    ...
    if (files && files.length) {
        ...
        for (const file of files){
            ...
            const filename = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$node_modules$2f$uuid$2f$dist$2d$node$2f$v4$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()}.${ext}`;
    ...
    const project = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$models$2f$Project$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createProject"])({
        title,
        description,
        tags,
        images,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$POST_up$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(project, {
        status: 201
    });
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d5b410e._.js.map