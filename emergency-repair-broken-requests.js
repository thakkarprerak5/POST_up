// Emergency repair script for the 3 specific broken group requests
const mongoose = require('mongoose');

async function emergencyRepairBrokenRequests() {
  try {
    ...
    console.log('\n🔧 EMERGENCY REPAIR: 3 BROKEN GROUP REQUESTS');
    console.log('==========================================\n');

    // The 3 specific broken request IDs from the logs
